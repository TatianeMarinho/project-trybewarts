...
Neste projeto, foi desenvolvido uma página de formulário da Escola de Magia de Trybewarts, em que as pessoas estudantes poderão enviar seus feedbacks sobre ela. O tema desse projeto é baseado na obra 'Harry Potter', de J. K. Rowling.<br>
Projeto desenvolvido em **dupla** com a [Stefani Almeida](https://github.com/almeidastefani)<br>

Todos os requisitos tem como base a página a seguir, que representa um formulário de avaliação da **Escola de Magia de Trybewarts**. A imagem do site foi usada como base e respeitado o posicionamento dos elementos.
...
Foram criados os arquivos `index.html`, `style.css` e `script.js`, que conterão o código HTML, CSS e JavaScript, respectivamente.
